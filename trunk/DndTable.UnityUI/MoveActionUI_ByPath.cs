...
{
    public class MoveActionUI_ByPath : BaseActionUI
    {
        ...
        private int MaxLength
        {
            get
            {
                if (_currentPlayer == null)
                    return 0;
                return _currentPlayer.CharacterSheet.Speed/5;
            }
        }
        //private int MaxLength { get { return 10; } }

        public MoveActionUI_ByPath(ICharacter currentPlayer, IMoveAction moveAction)
        {
